...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/registroclienteestilo.css" />
</head>
<body>
    ...
    <div class="container">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='cuota'>" . htmlspecialchars($row['cuota']) . "</td>";
        ...
        <form id="editForm" style="display:none;">
            ...
            <label for="editCuota">Cuota:</label>
            <input type="date" id="editCuota" name="cuota"><br><br>
            <button type="button" onclick="location.href='registro_clientes.php'">Cancelar</button>
            <button type="button" onclick="guardarCambios()">Guardar</button>
        </form>

        <a href="../gym/inicio.php">Inicio</a>
    </div>
    <script>
        ...
        function guardarCambios() {
            ...
            var cuota = $('#editCuota').val();

            $.ajax({
                url: '../controlador/controlador_editar_cliente.php',
                type: 'POST',
                data: {
                    dni: dni,
                    nombre: nombre,
        ...
        function eliminarRegistro(dni) {
            if (confirm('¿Está seguro de que desea eliminar este registro?')) {
                $.ajax({
                    url: '../controlador/controlador_eliminar_cliente.php',
                    type: 'POST',
                    data: { dni: dni },
                    success: function(response) {
                        alert(response);
