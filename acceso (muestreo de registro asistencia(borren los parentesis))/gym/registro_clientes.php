        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><button onclick='editarRegistro(" . htmlspecialchars($row['dni']) . ")'>Editar</button><button onclick='eliminarRegistro(" . htmlspecialchars($row['dni']) . ")'>Eliminar</button></td>";
                }
            } else {
                // Si no hay registros, muestra un mensaje en la tabla
                echo "<tr><td colspan='6'>No hay registros de asistencia.</td></tr>";
            }
            ?>
        </tbody>
    </table>
